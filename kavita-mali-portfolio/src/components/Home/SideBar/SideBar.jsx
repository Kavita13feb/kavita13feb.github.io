...
import './sidebar.css'
import { AiFillEye ,AiFillHome, AiTwotoneMail, AiFillPhone, AiFillGithub, AiFillLinkedin, AiOutlineFolderView, AiFillMessage } from "react-icons/ai"
  ...
  return (
    <SideBarContainer className='sidebar'  >
      ...
      <div className='full-screen-sidebar' >
        <img className="home-img" src='profile1.png'  width='50%' style={{ borderRadius: '50%', }} />
        ...
        <a  className='sidebar-contact-info'  href='Kavita_Mali_Resume.pdf'  target="_blank"onClick={()=>window.open("https://drive.google.com/file/d/1TwW36uYeOF6OPqBcDFCldVaHAhK_vdv9/view?usp=sharing")}><BsFillEyeFill size={"25px"} color="#a9afb7" /><button className= "sidebar-resume-btn">Reusme</button></a>
      </div>

    <div className='mid-screen-sidebar increasegap' >
        <img className="home-img" src='profile1.png' width='40%' style={{ borderRadius: '50%', }} />
       ...
       <Link >  <a   href='Kavita_Mali_Resume.pdf' download target="_blank"onClick={()=>window.open("https://drive.google.com/file/d/1TwW36uYeOF6OPqBcDFCldVaHAhK_vdv9/view?usp=sharing")}><button style={{display:"flex",justifyContent:"center",alignItems:"center",color:"rgb(27, 79, 98)",fontWeight:"bolder" ,gap:"8px",fontSize:"18px"}} className= "sidebar-resume-btn" >Reusme <AiFillEye size={"30px"}  /></button></a> </Link>
